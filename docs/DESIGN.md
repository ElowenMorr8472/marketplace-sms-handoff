...
> Design notes for **marketplace-sms-handoff** — a runnable typescript example that Typed SMS verification service that releases marketplace seller assets to the confirmed buyer.
...
- **Feature code** — the actual task: marketplace-sms-login.
